...
class Reg extends React.Component {
    ...
    register(reset) {
        ...
        if (reset) {
            ...
            if (
                this.checkValue(nameValue, 'Name') &&
        ...
        return (
            <div className="reg">
                ...
                <div>
                    ...
                    <button
                        className="but"
                        onClick={this.register.bind(this, false)}
                    >
                        sign
                    </button>
                    <button
                        className="but"
                        onClick={this.register.bind(this, true)}
                    >
                        reset
                    </button>
